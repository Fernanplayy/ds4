...
<asp:Button ID="b1" Text="1" runat="server" Height="37px" Style="margin-left: Opx"
Width="57px" OnClick="b1_Click" />
<asp:Button ID="b2" Text="2" runat="server" Height="37px" Style="margin-left: Opx"
...
<asp:Button ID="b4" Text="4" runat="server" Height="37px" Style="margin-left: Opx"
Width="57px" OnClick="b4_Click" />
<asp:Button ID="b5" Text="5" runat="server" Height="37px" Style="margin-left: Opx"
...
<asp:Button ID="b0" runat="server" Text="0" Height="37px" Style="margin-left: Opx"
