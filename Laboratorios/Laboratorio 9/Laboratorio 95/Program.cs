...
namespace Laboratorio_95
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("2. Generar un array con numeros aleatorios entre dos numeros aleatorios");
            Console.WriteLine("3. Generar un array con numeros no repetidos entre dos numeros aleatorios");
            ...
            switch (opcion)
            {
                ...
                case 3:
                    aleatorio.generarArrayNoRepetidos();
                    break;
            }
        }
    }
